...
export const getMulttaeData = async (stationCode = 'DT_0001') => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/today`, {
      params: { stationCode }
    })
...
export const getMulttaeDataByDate = async (stationCode, date) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/daily`, {
      params: { 
        stationCode,
...
export const getMulttaeDataWeek = async (stationCode) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/week`, {
      params: { stationCode }
    })
    return response.data
  } catch (error) {
...
export const getStationsByRegion = async (region) => {
  try {
    ...
    const response = await axios.get(`${BASE_URL}/api/multtae/stations`, {
      params: { region }
    })
...
export const getRegions = async () => {
  try {
    ...
    const response = await axios.get(`${BASE_URL}/api/multtae/regions`)
...
export const getRegionsWithStations = async () => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/regions/with-station`)
    return response.data
  } catch (error) {
...
export const getTideStationsWithWaveStation = async () => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/stations/with-wave`)
    return response.data
  } catch (error) {
...
export const getLinkedWaveStation = async (stationCode) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/stations/${stationCode}/wave`)
    return response.data
  } catch (error) {
...
export const testWind = async (windStationCode, date) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/test-wind`, {
      params: { 
        windStationCode,
...
export const testWave = async (waveStationCode, date) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/test-wave`, {
      params: { 
        waveStationCode,
        date: date.toISOString().split('T')[0]
      }
...
export const getMulttaeDataTomorrow = async () => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/tomorrow`)
    return response.data
  } catch (error) {
...
export const getMulttaeDataByRegion = async (location) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/location/${location}`)
    return response.data
  } catch (error) {
...
export const getMulttaeDataByLocation = async (latitude, longitude) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/location`, {
...
export const getStationInfo = async (stationCode) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/stations/${stationCode}/info`)
    return response.data
  } catch (error) {
...
export const getHourlyData = async () => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/hourly`)
    return response.data
  } catch (error) {
...
export const updateMulttaeData = async (data) => {
  try {
    const response = await axios.put(`${BASE_URL}/api/multtae`, data)
    return response.data
  } catch (error) {
...
export const deleteMulttaeData = async (id) => {
  try {
    const response = await axios.delete(`${BASE_URL}/api/multtae/${id}`)
    return response.data
  } catch (error) {
...
export const findNearestStation = async (latitude, longitude) => {
  try {
    const response = await axios.get(`${BASE_URL}/api/multtae/nearest-station`, {
      params: { latitude, longitude }
    })
    return response.data
  } catch (error) {
