...
const routes = [
    ...
    // partner pages
    {
        ...
        children: [
            ...
            {path: 'products/form/:id', component: () => import('@/views/pages/partner-page/ProductForm.vue')},
            {path: 'products/edit/:id', component: () => import('@/views/pages/partner-page/ProductForm.vue')},
            {
                path: 'market-info',
